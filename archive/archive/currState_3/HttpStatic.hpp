...
/*   Updated: 2024/02/03 21:08:15 by mberline         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class HttpStatic {
    public:
        ...
        ws_http::statuscodes_t  handleData( int socketfd, buff_t::const_iterator it_start, buff_t::const_iterator it_end );
    private:
