...
/*   Updated: 2024/01/23 11:58:58 by mberline         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
private:
    ...
    struct pollfd       _fds[WS_HTTP_SERVER_MAX_CONNECTIONS];
    int                 _nfds;
    HttpStatic*         _clients[WS_HTTP_SERVER_MAX_CONNECTIONS];
...
public:
    ...
    void start();
    void handleRead(int socketFd, int clientIndex);
    void handleWrite(int socketFd, int clientIndex);
    void handleAccept( void );
    void stopMonitoring(int socketFd, int clientIndex);
