...
/*   Updated: 2024/02/05 17:16:30 by mberline         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
private:
    ...
    std::vector<AHttpWrapper*>  _clients;
    buff_t                      _readBuffer;
    void    startMonitoring( int fd, short events, AHttpWrapper* data );
...
public:
    ...
    void runPoll( void );
    void handleRead( AHttpWrapper const & instance );
    // void handleWrite( std::size_t index );
    int  handleAccept( void );
    void stopMonitoring( AHttpWrapper const & instance );
    ws_http::statuscodes_t    processResponse( HttpWrapper& httpWrapper, ws_http::statuscodes_t statusCode, 
