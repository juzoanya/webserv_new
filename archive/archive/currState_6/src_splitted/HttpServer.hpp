...
/*   Updated: 2024/02/08 16:41:12 by mberline         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
    ...
    int     addMonitoring( int fd, short events, AHttpHandler* data, int otherIndex=-1 );
    bool    stopMonitoring( std::size_t index );
