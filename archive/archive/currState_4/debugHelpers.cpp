...
/*   Updated: 2024/02/04 09:57:30 by mberline         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	debPrintServerData(std::vector<HttpServ>& servers, bool printLocation)
{
	for (std::size_t i = 0; i != servers.size(); ++i) {
        debPrintIpPortData(std::string("server: ") +  toStr(i), servers[i].serverConfigs.ipPortData);
        std::vector<ConfigParser::ServerContext*> const & contextVec = servers[i].serverConfigs._serverConfigs;
