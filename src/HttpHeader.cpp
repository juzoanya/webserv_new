...
/*   Updated: 2024/02/21 20:03:37 by juzoanya         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int HttpHeader::reparseRequestLine( ws_http::method_t method, std::string const & requestTarget )
{
	...
	logging("reparsed: ", _headers[METHOD].second, EMPTY_STRING, EMPTY_STRING, EMPTY_STRING);
	logging("reparsed: ", _headers[PATH].second, EMPTY_STRING, EMPTY_STRING, EMPTY_STRING);
	logging("reparsed: ", _headers[PATH_DECODED].second, EMPTY_STRING, EMPTY_STRING, EMPTY_STRING);
	logging("reparsed: ", _headers[QUERY].second, EMPTY_STRING, EMPTY_STRING, EMPTY_STRING);
	logging("reparsed: ", _headers[FULLURI].second, EMPTY_STRING, EMPTY_STRING, EMPTY_STRING);
	logging("ret: ", ret, EMPTY_STRING, EMPTY_STRING, EMPTY_STRING);
	return (ret == -1 ? -1 : 1);
}
