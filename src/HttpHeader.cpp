...
/*   Updated: 2024/02/17 13:49:39 by mberline         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// HttpRequestLine HttpHeader::getRequestLine( void )
// {
//     return (HttpRequestLine(
//                 ws_http::methods_rev.at(_headers[METHOD].second),
//                 ws_http::versions_rev.at(_headers[VERSION].second),
//                 _headers[PATH_DECODED].second,
//                 _headers[QUERY].second,
//                 _headers[FULLURI].second
//             ));
// }
...
int HttpHeader::reparseRequestLine( ws_http::method_t method, std::string const & requestTarget )
{
    std::cout << "\n------ reparseRequestLine -------\n";
    if (!(_state & HEADER_DONE) || _state == -1)
        return (0);
    _headers[METHOD].second = ws_http::methods.at(method);
    ...
    std::cout << "reparsed: " << _headers[METHOD].second << std::endl;
    std::cout << "reparsed: " << _headers[PATH].second << std::endl;
    std::cout << "reparsed: " << _headers[PATH_DECODED].second << std::endl;
    std::cout << "reparsed: " << _headers[QUERY].second << std::endl;
    std::cout << "reparsed: " << _headers[FULLURI].second << std::endl;
